...
ALTER TABLE user_api
    ADD CONSTRAINT fk7va3mrikbo4f2gjns6m8d6116 FOREIGN KEY (api_tariff_id) REFERENCES user_api_tariff (id) ON UPDATE NO ACTION ON DELETE NO ACTION;
